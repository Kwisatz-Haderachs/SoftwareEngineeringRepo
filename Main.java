...
public class Main {
    ...
    public void exit(){
        try {
            String pFname = "gradebook.dat";
            GradebookWriter gbWriter = new GradebookWriter(pFname);
    ...
    /**
     * run() is the main routine and is called from main().PSEUDOCODE:
 method run
     ...
     -- class so they may communicate with each other.
     *
     * Then pass the newly created View object
